...
const CoursesPage = () => {
	...
	return (
		<div className="w-full h-[92dvh] flex justify-center items-center">
			...
			<div className="w-[90%] h-[80dvh] mx-auto bg-[--background] flex justify-center items-center rounded-[20px] shadow-[--bg] shadow-xl" >
						...
						<div className="flex justify-around gap-8">
							<div className="container w-[50%]">
								...
								<div className="mb-4">
									...
									<textarea className="shadow appearance-none border rounded w-full py-2 px-3 text-[--text] leading-tight focus:outline-none focus:shadow-outline" id="description" type="text" placeholder="Description" rows={5}></textarea>
								</div>
							...
							<div className="container w-[50%]">
								<div className="mb-4">
									...
									<input className="shadow appearance-none border rounded w-full py-2 px-3 text-[--text] leading-tight focus:outline-none focus:shadow-outline" id="name" type="text" placeholder="Name" rows={4} />
								</div>
								<div className="mb-4">
									<label className="block text-[--text] text-sm font-bold mb-2">
										duration
									</label>
									<input className="shadow appearance-none border rounded w-full py-2 px-3 text-[--text] leading-tight focus:outline-none focus:shadow-outline" id="duration" type="number" placeholder="Duration"/>
								</div>
								...
								<div className="mb-4">
									...
									<input className="shadow appearance-none border rounded w-full py-2 px-3 text-[--text] leading-tight focus:outline-none focus:shadow-outline" id="fees" type="text" placeholder="fees" rows={4} />
								</div>
								...
								<div className="mb-4">
									...
									<input className="shadow appearance-none border rounded w-full py-2 px-3 text-[--text] leading-tight focus:outline-none focus:shadow-outline" id="start_date" type="date" rows={4} />
								</div>
								...
								<div className="mb-4">
									...
									<input className="shadow appearance-none border rounded w-full py-2 px-3 text-[--text] leading-tight focus:outline-none focus:shadow-outline" id="end_date" type="date" />
								</div>
							</div>
						</div>
						<div className="flex items-center justify-start gap-8 mt-4">
							<button className="bg-[--primary] hover:bg-[--primary-400] transition-colors text-[--background] font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" type="submit">Submit</button>
